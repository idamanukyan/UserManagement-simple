...
public class JwtTokenUtil {
    ...
    public Map<String, String> generateUserToken(User user, Collection<String> permissions) {
        return doGenerateToken(user.getEmail(), UserType.USER, user.getId(), permissions);
    }

    public Map<String, String> generateAdminToken(Admin admin, Collection<String> permissions) {
        return doGenerateToken(admin.getEmail(), UserType.ADMIN, admin.getId(), permissions);
    }
